...
const ICS_FILES = [
  { path: './src/data/mototiming-MotoGP-calendar-2025.ics', category: 'MotoGP' },
  { path: './src/data/mototiming-Moto2-calendar-2025.ics', category: 'Moto2' },
  { path: './src/data/mototiming-Moto3-calendar-2025.ics', category: 'Moto3' }
];
