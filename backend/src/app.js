...
app.use(helmet({
  contentSecurityPolicy: {
    ...
    directives: {
      defaultSrc: ["'self'"],
      scriptSrc: ["'self'", "'unsafe-inline'", 'https://apis.google.com', 'https://www.tiktok.com', 'https://www.instagram.com'],
      styleSrc: ["'self'", "'unsafe-inline'", 'https://fonts.googleapis.com'],
      fontSrc: ["'self'", 'https://fonts.gstatic.com'],
      imgSrc: ["'self'", 'data:', 'https://*'],
      connectSrc: ["'self'", 'https://free.keikodev.es', 'https://keikodev.es', 'https://www.tiktok.com', 'https://www.instagram.com'],
      frameSrc: ["'self'", 'https://www.tiktok.com', 'https://www.instagram.com'],
    },
  },
