...
const calculatePreview = (form) => {
  ...
  const netProfitWithoutRounding = finalPrice - totalCostPerProduct;
  const profitOverPricePercentWithoutRounding = finalPrice > 0
    ? (netProfitWithoutRounding / finalPrice) * 100
    : 0;
  ...
  return {
    ...
    finalPriceRounded,
    netProfitPerProduct,
    netProfitWithoutRounding,
    profitOverPricePercentWithoutRounding,
  };
};
    ...
    <div className="print-cost-page">
      ...
      <section className="print-cost-card print-cost-card--results">
        ...
        <ul>
          ...
          <li><span>Beneficio neto sobre PVP (sin redondear)</span><strong>{round(preview.netProfitWithoutRounding)} €</strong></li>
